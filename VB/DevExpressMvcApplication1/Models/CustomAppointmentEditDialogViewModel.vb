...
Namespace DevExpressMvcApplication1.Models
    Public Class CustomAppointmentEditDialogViewModel
        ...
        Public Overrides Sub Load(ByVal appointmentController As AppointmentFormController)
            ...
            SetDataItemsFor(Function(m) DirectCast(m, CustomAppointmentEditDialogViewModel).AppointmentCompany, Sub(addItemDelegate)
                                                                                                                    For Each comp As Company In companies
                                                                                                                        addItemDelegate(comp.CompanyName, comp.CompanyID)
                                                                                                                    Next comp
                                                                                                                End Sub)

            SetDataItemsFor(Function(m) DirectCast(m, CustomAppointmentEditDialogViewModel).AppointmentContact, Sub(addItemDelegate)
            ...
            TrackPropertyChangeFor(Function(m) DirectCast(m, CustomAppointmentEditDialogViewModel).AppointmentCompany, Sub()
